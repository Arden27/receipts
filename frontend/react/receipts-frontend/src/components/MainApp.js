	...
	return (
		<div className="App grid h-screen grid-cols-2 grid-rows-[auto_auto_1fr]">
			<nav className="col-span-2 flex justify-between bg-blue-400 p-4 text-white">
				<button onClick={handleToggleReceiptForm} className={addingReceipt ? "rounded border border-red-500 bg-white px-4 py-2 font-bold text-red-500 hover:bg-red-500 hover:text-white" : "rounded bg-green-500 px-4 py-2 font-bold hover:bg-green-700"}>
